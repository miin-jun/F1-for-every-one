...
// // 파일 맨 위에 추가
// window.sendCurrentMessage = sendCurrentMessage;  // 전역으로 노출
...
//         // 봇 메시지면 TTS 재생 (voice.js의 playTTS 함수 사용)
//         if (type === 'bot' && typeof playTTS === 'function') {
//             playTTS(text);
//         }
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    async function openChat(chatId) {
        ...
        if (shouldUpdateUrl && chatStore[chatId].backendChatId) {
    ...
    function renderHistory() {
        ...
        chatOrder.forEach(function (chatId) {
            ...
            titleButton.addEventListener("click", function () {
                ...
                const backendChatId = chatStore[chatId].backendChatId;
