...
43
C3.13
Bodywork not defined in Articles C3.5 to C3.12
43
C3.14
Wheel Components
44
...
154
C15.3
Specific Prohibitions and Restrictions (Components Outside the PU Perimeter)
157
C15.4
Specific Exceptions (Components Outside the PU Perimeter)
158
C15.5
...
178
C17.6
Defined Specification Components (DSC)
179
C17.7
...
186
C18.5
Defined Specification Power Unit Components (DSPUC)
188
C18.6
...
Interpretation of and amendments to these Technical Regulations
C1.3.1
The definitive text of the Technical Regulations shall be the English version which will be used
should any dispute arise as to their interpretation.
C1.3.2
Headings in this document are for ease of reference only and do not affect the meaning of the
...
c.
A su_ix may be used for local coordinates in specific rules, (e.g. XW, YW, ZW), where these local
...
e.
A wheel is defined to be in the straight−ahead position when its rotational axis lies in an
X−Plane.
...
j.
references to axis aligned geometry are aligned to the Car Coordinate System defined in
C2.1.1.
k.
...
e.
Once the Wheel Coordinate System is defined as above, then it maintains a fixed orientation
relative to the suspension upright at all other suspension articulations.
C2.2
Principal Planes
a.
The Plane Z = 0 is defined as a horizontal plane sitting at the bottom of the sprung part of the
car, except for the Plank Assembly defined in Article C3.6.
b.
The Plane Y = 0 is defined as the plane of symmetry of the car.
c.
The Plane XA = 0 is defined as the X−Plane that lies on the forward limit of the Survival Cell.
d.
The Plane XC = 0 is defined as the X−Plane at the rear of the Cockpit.
e.
The planes XF = 0 and XR = 0 are defined as the X−Planes which respectively pass through the
...
f.
The plane XDIF = 0 is defined as the X−Plane containing the axis of rotation of the final drive as
defined in Article C9.5.1.
g.
The plane XPU = 0 is defined as the X−Plane which passes through the mounting face of the
connections between the ICE and the Survival Cell, as defined in Article C5.4.17.
h.
The plane XFIS = 0 is defined as the X−plane passing through the forward most point of the Front
Impact Structure.
C2.3
Fundamental Dimensions
C2.3.1
...
iv.
primary heat exchangers, as defined in Article C7.4.1 (b).
b.
The following components are not Bodywork:
i.
cameras and camera housings, as defined in Article C8.16.
ii.
rear view mirrors as defined in Article C14.2.
...
Bodywork must:
a.
be rigidly constructed and immobile relative to their defined Frame of Reference defined in
Article C3.4.
b.
...
a.
maintain both continuity and tangency with the filleted parts.
b.
fit within an Acute Circular Cone whose:
i.
...
b.
are flush with the underlying geometry.
c.
...
by realigning each of the groups of Reference Volumes and Reference Surfaces that define the
assemblies, by up to 2mm, from their original position, to best fit the measured geometry.
d.
Irrespective of (b), and except for regions within the three holes defined in Article C3.6, a
...
ii.
Tape, provided it does not achieve an aerodynamic effect not otherwise permitted by
Article C3.
...
e.
Within an axis-aligned cuboid with an interior diagonal defined by points [XC = 0, −40, 1120] and
[XC = 150, −175, 840].
f.
...
a.
Ducts (as specified in C3.1 (a) (ii) and C3.1 (a) (iii).
b.
...
b.
be rigidly fixed to any bodywork it intersects.
c.
...
b.
have up to five sections in any X and Z-Plane.
c.
...
Floor Corner.
h.
Floor Tyre IR Sensor, if fitted.
...
ii.
be fixed on its inboard end to the entirely sprung part of the car.
...
C
ii.
be rigidly fixed at its inboard end to Forward Chassis.
...
ii.
be fixed at its inboard end to Forward Chassis.
...
a.
The material of the Plank is free, but it must be homogeneous with a specific gravity between
...
i.
be made to the geometry defined by RV-SKID-FWD and associated drawing.
ii.
be divided into three separate parts as defined in the Reference Volume.
...
i.
be made to the geometry defined by RV-SKID-MID and associated drawing.
ii.
be divided into three separate parts as defined in the Reference Volume.
c.
...
C
i.
be made to the geometry defined by RV-SKID-REAR and associated drawing.
ii.
be divided into three separate parts as defined in the Reference Volume.
d.
...
a.
RV-SKID-FWD: three fixings in each of the two forwardmost resulting Skids and two fixings for
the rearward most resulting Skid.
b.
RV-SKID: two fixings in each of the resulting Skids.
c.
...
f.
Mounting brackets defined in Article C8.16.7.
C3.7.2
Forward Chassis
...
ii.
25mm of the Aperture defined in Article C3.16.10.
d.
...
ii.
within 20mm of the CCU Antenna, defined in Article C8.5.4, where the radius of curvature,
...
provided the linkage lies in its entirety within Front Wing Profiles or Front Wing Endplate.
k.
At all points along the span, the minimum distance between adjacent Front Wing Profiles
...
Front Wing Inboard Footplate.
d.
Front Wing Endplate Diveplane, if fitted.
...
g.
when viewed from above, fully obscure Front Wing Strake forward of XF = −715, if fitted.
C3.10.10
Front Wing Adjuster System
The “Front Wing Adjuster System” is defined as follows:
a.
“FW Primary Flap”, if fitted, must:
i.
be a continuous portion of Front Wing Profiles, excluding the forwardmost volume.
...
C
ii.
rotate about the “Primary Axis”, which must pass through Point A and Point B and be fixed
relative to the forwardmost volume of Front Wing Profiles.
b.
“FW Secondary Flap”, if fitted, must:
i.
be a continuous portion of only the rearmost volume of Front Wing Profiles.
ii.
...
Profiles.
c.
Both FW Primary Flap and FW Secondary Flap must include any fitted Gurneys and any parts
...
ii.
pass through Point A for the first surface and Point B for the second surface.
...
C
k.
not result in a decrease in incidence of the tangent lines defined in Article C3.10.1 (g) (i).
l.
result in a maximum deviation for any point of Front Wing Profiles no greater than:
i.
...
n.
when commanded, switch to one of two fixed positions defined as follows:
i.
a “Corner Mode” position, that conforms to a position defined in (k) and that remains
...
q.
be measured by position sensors, one for each of the actuators defined in (p), which:
i.
are mechanically linked to Front Wing Profiles.
ii.
...
Furthermore:
s.
Irrespective of whether the adjustment is controlled by the FIA Standard ECU, any fitted FW
Primary Flap and FW Secondary Flap must:
i.
except for Front Wing Fishplates, Front Wing Adjuster Fairing and any fitted Gurneys,
...
non-adjustable parts of Front Wing Fishplates, throughout the range of deviation defined
in C3.10.10 (l).
b.
Up to eight Hangers, each of which must:
i.
intersect two adjacent volumes of Front Wing Profiles.
ii.
...
have up to two sections in any Y-Plane.
e.
A single “FW SLM Mid Fairing”, that may only be fitted to enclose the actuator defined in
...
f.
A single “FW SLM MID Pillar”, that may only be fitted alongside FW SLM Mid Fairing, and must:
i.
lie in its entirety within both an axis aligned cuboid of the following dimensions [X, Y, Z] =
[250, 50, 100] and RV-FW-SLM-MID.
...
ii.
intersect both Front Wing Profiles and one of Nose, or FW SLM Mid Fairing or Front Wing
Endplate Body.
...
ii.
intersect for the entire range of adjustment, the adjustable part of Front Wing Profiles not
...
ii.
intersect either Front Wing Profiles or Front Wing Endplate.
...
l.
the total of Hangers plus Front Wing Rotation Brackets fitted to Front Wing Assembly must not
exceed ten.
...
n.
flexible seals may be fitted between the adjustable and non-adjustable parts of Front Wing
...
g.
at all points along the span, the minimum distance between adjacent Rear Wing Profiles
...
Furthermore:
c.
no part of Rear Wing Profiles may be obscured by Rear Wing Pylon when viewed from above.
C3.11.5
Rear Wing Assembly
...
a.
“RW Flap” is constructed solely from Rear Wing Profiles and must:
i.
...
iv.
include any fitted Gurney and any parts of Rear Wing Auxiliary Components that are rigidly
...
when commanded, switch to one of two fixed positions defined as follows:
i.
a “Corner Mode” position, that exactly conforms to the position of Rear Wing Profiles
...
b.
However, between three and five pairs of “Rear Wing Separators” must be fitted across both
sides of the car. Each pair must:
i.
lie in its entirety within an individual, freely positioned instance of RV-RW-SEPARATOR.
ii.
intersect both the forwardmost volume of Rear Wing Profiles and RW Flap.
...
place.
h.
flexible seals may be fitted between the adjustable and non-adjustable parts of Rear Wing
...
volumes.
d.
once all volumes are trimmed and filleted, no part of Engine Cover, the Fillet Radius between
...
C3.13.3
A fairing may be attached to the Secondary Roll Structure, or the cameras defined in Articles C8.9.3
...
C3.13.4
Ducts (as specified in C3.1.a.ii and C3.1.a.iii) and Primary Heat Exchangers, which must not be
...
a.
Any Bodywork subject to Wheel Bodywork Assembly as per Article C3.15 must first be
classified under one of the groups specified in Article C3.14.
b.
Unless otherwise specified, all Bodywork in Article C3.14 must be present and fitted after
Wheel Bodywork Assembly as per Article C3.15.
c.
Compliance of each Bodywork component defined in Article C3.14 and Article C3.15 with
...
a.
be made to the geometry defined by RS-FWH-DRUM and RS-RWH-DRUM respectively.
Furthermore:
b.
Drum Bodywork must be fitted with an Aerodynamic Seal, in the outboard of the two annotated
...
c.
Drum Bodywork may be fitted with a flexible seal or seals, in the inboard of the two annotated
...
Furthermore:
d.
Front Lip Bodywork is optionally fitted and exempt from Article C3.14.1 (b).
e.
...
Furthermore:
d.
Rear Drum Deflector Bodywork is optionally fitted and exempt from Article C3.14.1 (b).
...
C
b.
Deflector Leading Edge, which must:
i.
...
b.
lie no closer than 20mm to any other Front Drum Deflector Stay.
c.
in any plane normal to the axis of the right circular cylinder defined in (a), have at least one axis
 of symmetry.
...
f.
is optionally fitted and exempt from Article C3.14.1 (b).
C3.14.9
...
Furthermore:
a.
if present, the Front Drum Front Deflector, defined in Article C3.14.6, must be Trimmed and
...
C
b.
if present, the Hangers, defined in Article C3.14.9 (a), must be Trimmed and Combined to the
Front Outboard Wheel. Fillet Radii no greater than 4mm may be applied at the intersections
between these volumes.
c.
if present, the Debris Guard, defined in Article C3.14.9 (b), must be Trimmed and Combined to
...
b.
not have any resultant flux across a circular section 155mm in diameter with its centre lying
...
h.
except for regions of zero or incidental flows, which the FIA may request be demonstrated, only
...
accommodate a 5 10mm offset of the Swept
...
Suspension and Driveshaft Fairings
C3.17.1
“Suspension Fairings” must be fitted to all suspension members defined in Article C10.3.6,
...
e.
have an incidence (defined as the angle between the major axis and the plane Z=0 with the car
...
C3.17.5
A “Driveshaft Fairing” may be fitted around the driveshaft defined in Article C9.10 and must cover
...
compliance with C3.3.1 (a).
C3.17.7
In order to permit suspension travel while maintaining an Aerodynamic Seal, minimal flexible
components may be fitted between a Suspension or Driveshaft Fairing and the following
components:
a.
Wheel Bodywork, as defined in Article C3.15.
b.
Front Bodywork, as defined in Article C3.7.
c.
Engine Cover Bodywork, as defined in Article C3.8.2.
...
C
d.
Tail Bodywork, as defined in Article C3.9.
e.
Gearbox Case, as defined in Appendix C1.
f.
Rear Wing Pylon, as defined in Article C3.11.4.
g.
...
i.
except for the Fillet Radius defined in (h), conform with the shape restrictions of either of the
...
Aerodynamic Component Flexibility
C3.18.1
Introduction of load/deflection tests
...
a.
have a flat top surface without recesses.
b.
be fitted to the car to apply the full load to the bodywork at the test point and not to increase
...
flap.
When tested, the flap must be in Cornering Corner Mode.
...
a.
 The Front Wing Endplate may deflect no more 7mm when a 60N load is applied vertically
downwards anywhere on its periphery.
b.
 The Front Wing Endplate may deflect no more 7mm when a 60N load is applied in the Y-
...
a.
Bodywork flexibility will be tested by applying a load vertically upwards through a gimbled
...
straight-line graphs defined by connecting the following coordinates in order:
...
0
C
At the hole positioned between XC=−600 and XC=−800, the stiffness must always exceed 3kNmm-1.
...
a.
The Floor Bodywork may deflect no more than 5mm, when measured along the loading axis,
...
b.
Floor Bodywork must deflect no more than 7mm when a load of [0, ±60, 0]N (inboard or
...
Diiuser Flexibility
a.
Floor Bodywork must deflect no more than 5mm when two loads of [0, 0, -100]N are applied
...
b.
Floor Winglet Bodywork must deflect no more than 7mm when a 60N load is applied normal to
...
to the RIS. Linear deflection will be measured along axis of the load application and relative to the
RIS.
C3.18.11
...
the car centre plane using a spherical 15mm diameter tip at [XR, Z] = [675 670, 550]. The deflection
...
C3.19.2
The Secondary Roll Structure fairings, defined in Article C3.13.3, must be made to the laminate
PL−HALO.
C3.19.3
Floor
...
plane:
i.
the mass measured at the front axle must not be less than the Minimum Mass specified in
Article C4.1 factored by 0.44.
ii.
the mass measured at the rear axle must not be less than the Minimum Mass specified in
...
i.
The difference in mass between the driver’s personal equipment normally used and that
...
C5.1.3
All engines must have six cylinders arranged in a 90° “V” configuration and the normal section of
...
Cylinder Head itself defined by C5.7.8 g), any coating on the Cylinder Head permitted by C5.6.2, or
...
C5.1.8
Unless specified otherwise, the total volume of Inserts within ICE components related to items 1
...
C5.1.10
All Power Unit breather fluids may only vent to atmosphere and must pass through a single orifice
which is positioned behind XR=0, inboard of Y=100 and below Z=400. No breather fluids may
...
C5.1.12
The Power Unit may be equipped with a maximum of two Wastegates and two Pop-OFF Valves. Only
...
C5.1.14
All Wastegate exit fluids must pass through a Wastegate tailpipe which must be connected to the
Exhaust Tailpipe, downstream of the turbine wheel.
C5.1.15
All Pop-OFF exit fluids must pass through a return line which must be connected downstream of
the inlets specified in C5.6.1 and upstream of the compressor wheel
C5.1.16
For the purpose of Component Classification in Table 1 of Appendix C4, Thermal Insulation that is
...
C5.1.17
The Clutch assembly, including but not limited to friction plates, springs, cover plate, may be fitted
...
C5.2.2
 Energy flows, power and ES state of charge limits are shown in the energy flow diagram below:
...
C5.2.6
When assessing compliance with the above two articles, the fuel mass flow rates measured by the
...
C5.2.9
The difference between the maximum and the minimum state of charge of the ES may not exceed
...
b.
Electrical energy may not flow from or into the ES and CU-K without being directly measured
...
d.
An airgap of 1mm must be present between the CU-K and any other consumer fitted inside the
...
instantaneous power higher than 2W may not flow from CU-K logic or driver boards (usually
...
C
C5.2.15
Cars must be fitted with homologated sensors which provide all necessary signals to the FIA data
...
C5.2.21
A fixed efficiency correction of 0.97, or its inverse where appropriate, will be applied by the Standard
...
Turbo Charger
C5.3.1
Pressure charging may only be affected by the use of a sole single stage, single sided Turbo Charger
...
The procedure which will be used to assess compliance with this article must be defined by each
...
Longitudinal plane, and be symmetrically arranged about the Lateral plane
c.
The spark plug axis must intersect the Transverse plane within a quadrilateral defined by the
...
C5.4.16
All elements of the Power Unit specified in the relevant column of the table in Appendix C4 must be
...
f.
All elements within the ES Main Enclosure (defined in Article C5.19.7).
C5.4.17
...
Mass and centre of gravity
C5.5.1
Depending on where the MGU-K Mechanical Transmission (as defined in item 27 of Appendix C4) is
...
C
C5.5.8
ICE Ballast may be fitted to the ICE in order to achieve the required mass subject to the following
restrictions:
a.
...
C5.6.3
There must be no more than one butterfly or rotating barrel, as explained in the Throttle definition,
...
C
C5.8.2
All turbine exit and all Wastegate exhaust fluids must pass through the Exhaust Tailpipe defined in
Article C3.9.2.
C5.8.3
The wall thickness of all exhaust pipes from the Cylinder Head exhaust flange to the turbine
...
C5.8.4
The engine must be equipped with lambda sensors either fitted into each exhaust secondary, one
...
permitted.
C5.9.3
All cars must be fitted with a Fuel Flow Meter, wholly within the fuel tank. This sensor may only be
...
C5.9.5
Any device, system or procedure the purpose and/or effect of which is to increase the flow rate or
...
Ancillaries
C5.11.1
Unless specified otherwise, Ancillaries must be mechanically or electrically driven. Any electrically
...
C5.12.7
The electrical DC power of the ERS-K may not be reduced at rates greater than those specified in
...
C5.12.8
Specification of power limited pending, power limited, overtake mode Boost mode and details of
...
C5.13.2
Teams may be required to demonstrate the accuracy of the Power Unit configurations used by the
FIA Standard ECU.
C5.13.3
Power unit control must not be influenced by clutch position, movement or operation.
C5.13.4
...
C5.13.9
Any pressure sensor used to measure pressure of any fluid necessary to ensure the Power Unit
...
a.
Have been supplied by an FIA designated manufacturer and fitted to the car in accordance with
...
C5.17.7
 The following elements of the Power Unit must be fitted inside the ES Main Enclosure installed
within the ERS Reference Volume (RV-PU-ERS):
a.
ES elements as defined in items 35 (ES) and 38 (HV elements) of Appendix C4.
b.
The HV safety elements and sensors defined in items 36 (DC sensor, IMD) and 37 (safety
...
C5.17.8
 In addition to the components listed in Article C5.19.7, the following elements may also be fitted
within the ES Main Enclosure:
a.
Low voltage Power Distribution Board (PDB).
b.
PU Electric pump Driver units and non ICE-mounted ERS cooling systems as defined in item
59 of Appendix C4.
c.
...
e.
General electrical devices exclusively used for PU functionalities, as defined in item 42 of
Appendix C4
...
C5.17.9
The minimum mass for the ES Main Enclosure PU Mass group elements as defined in Appendix C4
is 35.0kg. The procedure which will be used to determine this value may be found in the document
FIA-F1-DOC-105.
C5.17.10
Any significant debris resulting from a failure of the elements located inside the RV-PU-ERS and
...
C5.18.6
The thickness of the stack magnetic soft alloy laminated sheets may not be less than 50μm.
C5.18.7
...
C5.18.8
All rotating parts of the MGU-K and its mechanical transmission must have a fixed inertia by design.
...
C
C5.18.9
The elements defined in item 31 (MGU-K torque sensor shaft) of Appendix C4 must be
...
November of the preceding year.
C5.19.2
Solely a single specification of cell may be homologated, including the same exiting position of the
...
C5.19.4
A diode must be fitted, in series, at the DC-DC Unit positive high voltage pole to ensure that
...
C5.19.6
With the exception of the ES safety systems, the ES Cells defined in C5.2.25 are the only energy
...
C5.20.10
The ES Main Enclosure material(s) must satisfy a minimum fire protection equivalent of UL94 V0
...
i.
If, under the provisions of Article C5.20.1, the MGU-K is fixed to the ICE, the PU manufacturer
...
C5.21.7
The UN38.3 Energy Store transportation certification must be shared with the FIA during the
...
C5.22.6
 The use of an Auxiliary Oil Tank, or other forms of oil storage other than the single oil tank defined
...
Fuel tanks
C6.1.1
The fuel tank must be a single rubber bladder conforming to or exceeding the specifications of FIA
...
C6.1.4
All fuel tanks must be fitted with a pressure relief valve to prevent overpressure, and with a fuel tank
...
Fittings and piping
C6.2.1
The total area of apertures in the fuel bladder must not exceed 35 000mm2.
...
ii.
Have bolt hole edges no less than 5mm from the edge of the bolt ring, hatch, or fitting.
...
C
C6.2.2
Where the fuel bladder is attached to the Survival Cell, fixings must be designed so that if it is pulled
...
C6.2.5
All lines must be fitted in such a way that any leakage cannot result in the accumulation of fuel in
the Cockpit.
C6.2.6
...
All fuel tank fillers and breathers must be designed to ensure an e_icient locking action which
reduces the risk of an accidental opening following a crash impact or incomplete locking after
refuelling.
C6.4
Refuelling
C6.4.1
A cover must be fitted over any refuelling connector at all times when the car is running on the track.
...
C6.5.3
It must be possible to take a fuel sample drawn from the fuel collector are as defined in the fuel
...
C6.6.3
All flexible pipes and hoses and their fittings between the primer pump and the High Pressure Fuel
...
C6.6.5
If a fuel pressure damper is fitted it must be fitted upstream of the Fuel Flow Meter described in
article C5.9.3.
C6.6.6
...
C7.3.2
All lines must be fitted in such a way that any leakage cannot result in the accumulation of fluid in
the Cockpit.
C7.3.3
...
e.
Heat Exchanger Fins fitted inside the tubes must have a thickness of at least 0.06mm. Heat
...
C8.1.2
The FIA must be notified of any changes prior to the Competition at which such changes are
...
Telemetry
C8.5.1
All cars must be fitted with a car to F1 Team Telemetry system which has been manufactured by the
...
a.
The FIA Marshalling System defined in Article C8.11;
b.
Handshaking required by the car to F1 Team telemetry system defined in Article C8.5.1.
C8.5.4
...
Driver radio
C8.8.1
All cars must be fitted with a voice radio communication system which has been manufactured by
...
c.
With each of its 12 edges parallel to the coordinate system defined in Article C2.1.
d.
...
h.
Within the operating limits specified by the supplier, in particular the maximum temperature
limits.
...
c.
With each of its 12 edges parallel to and matching the coordinate system defined in Article
C2.1.
d.
...
FIA Marshalling system
C8.11.1
All cars must be fitted with a marshalling system, comprising a car positioning system and a
...
Installation of electrical systems or components
C8.14.1
Exceptionally, each car may be equipped with a maximum of five test sensor installations, which
do not comply with Article C3, during P1 and P2, provided:
a.
They could not materially affect the outcome any of the impact tests described in Article C13.
b.
...
C8.14.2
F1 Teams must be notified of any changes to the installation instructions for any FIA specified
...
C
c.
 a camera fitted in the driver’s helmet and pointing forward,
d. a camera in position 6.
C8.16.2
Details concerning the technical specification of all cameras may be found in the document FIA-
F1-DOC-022.
C8.16.3
...
C8.16.4
F1 Teams must be notified of any changes to the camera or transponder installation instructions
before 30 June of the previous season.
C8.16.5
Any camera fitted in positions 2, 3 or 4 shown in Drawing 2 of Appendix C3 must be mounted in
...
e.
Where two paddles are fitted, they must be a left and right handed pair, identical in function
...
C9.2.4
Designs or systems which are designed to, or have the effect of, adjusting or otherwise influencing
...
Gearshifts.
c.
Bite point finder where brake pressure, wheel speed and driver clutch demand safeguards are
used.
d.
...
C9.2.7
Any device or system which notifies the driver of the amount of Clutch slip or engagement is not
permitted.
C9.3
Clutch Disengagement System (CDS)
...
at 15 000rpm.
C9.8.3
The minimum possible gear the driver is able to select must remain fixed whilst the car is moving.
...
Torque transfer systems
C9.9.1
Any system or device the effect of which is capable of transferring or diverting torque from a slower
...
C10.2.4
Any powered device which is capable of altering the configuration or affecting the performance of
...
C10.2.6
On each axle, the state of its suspension system must be uniquely defined by the angular position,
...
h.
Mass Dampers, as defined in Appendix C1.
C10.3
Outboard suspension
C10.3.1
With the steering wheel rotation fixed, the position of each wheel centre and the orientation of its
...
C10.3.4
The outboard attachment points of each suspension member (defined as the kinematic centre of
...
c.
Inside the Drum defined in Article C3.14.2.
...
a.
In any normal cross section relative to its load line (defined as a straight line between the inner
...
C10.5.2
The re−alignment of the steered wheels must be uniquely defined by a monotonic function of the
...
car.
C10.5.4
No part of the steering wheel or column, nor any part fitted to them, may be closer to the driver than
...
and fixing of a suspension member outboard attachment point, conforming to Article C10.3.4 (a) to
...
b.
The Wheel Rim must be a solid of rotation formed by revolving a single profile around the axis
...
c.
Once the revolved solid has been fully defined, material may be :
i.
...
iv.
removed on the outer flanges, between a radius of 238mm and a radius of 246mm from
...
c.
A Complete Wheel must contain a single fixed internal gas volume. No valves, bleeds or
...
ii.
Provide a unique and unambiguous identification that enables the FIA to identify and
...
C10.9.2
With the exception of manual torque wrenches, devices which are used to fit or remove wheel
...
C10.9.3
All cars, whilst under their own power, must be fitted with dual stage devices which will retain the
...
Brake callipers
C11.2.1
Brake callipers are defined as the parts of the braking system outside the Survival Cell, other than
...
c.
The minimum dimensions of the Survival Cell between XA=0 and XC=0 are defined by the union
of RV−CH−FRONT−MIN and RV−CH−MID−MIN.
d.
The Survival Cell must fully enclose RS-PU-ERS.
e.
The maximum dimensions of the Survival Cell between XA=0 and XC=−875 are defined by the
...
C
f.
Material may be removed from the upper front part of the volume defined in (c) above. In order
...
i.
After the first stage of material removal, the external surface of the Survival Cell forward
...
ii.
In the second stage, further material may be removed down to the Z−plane defined above.
...
C
c.
Be for the sole purpose of routing wiring looms, cables or fluid lines, the total combined area
...
opening.
e.
Be for team specified sensors. The total combined area of any such openings must not exceed
1500mm2.
...
b.
For the sole purpose of allowing the Secondary Roll Structure front fixing and fairings to be
...
d.
Minimal Recesses for the sole purpose of mounting team specified components. Including but
...
b.
A horizontal section through the structure at Z=950 must enclose an area of at least 6000mm2.
...
symmetrically about the car centre plane with its front fixing axis at XC= −975 and Z=660. The
mounting faces for the rearward fixings must lie on the plane Z=695.
...
PL−HEADREST.
d.
Are positioned to be the first point of contact for the driver's helmet in the event of an impact
...
o.
A keyhole fixing at XC= −250 ±50mm and Z=610 ±25mm on each side of the car. These fixings
...
C
p.
A quick release fixing which is clearly indicated at the front corner on each side of the car. No
...
d.
Cover the area 50mm above the lower surface of the volume defined in Article C12.5.4.a, over
...
f.
Must be enclosed by the union of the Floor Bodywork and the fairing defined in Article C3.5.14.
...
General Principles
C13.1.1
The purpose of this Article is to define the safety structures of the car and all the homologation
...
DOC-002.
C13.1.4
For all impact tests, all parts that could materially affect the outcome of the test must be fitted.
...
C13.1.5
Any significant modification introduced into any of the structures tested shall require that part to
pass a further test.
C13.1.6
...
c.
Be fitted in a vertical sense in order to ensure force distribution is similar to that with the nose
fitted.
d.
...
b.
A Secondary Roll Structure must be fitted.
c.
The loads shall be applied using a 150mm diameter flat, rigid pad whose centre lies in the
...
d.
For each test, peak loads must be applied in less than three minutes and be maintained for five
seconds.
e.
After five seconds of application, there must be no failure of any part of the Survival Cell or of
...
c.
Deflections and deformations will be measured at the centre of area of the load pad unless
otherwise stated.
d.
Unless specified otherwise, all peak loads must be applied in less than three minutes, through
...
h.
Any significant modification introduced into any of the structures tested shall require that part
...
nominal strength.
Excluding fairings or any bodywork defined as Front Wing Assembly; Between XFIS = 50 and
...
i.
One will be subject to push-off tests described in ArticlesC13.6.3.a and C13.6.3.b
followed by the dynamic test described in ArticleC13.6.5.
and
ii.
The second will be subject to push-off test described in ArticlesC13.6.3.c followed by the
...
The load must be applied through a ball−joint, using a pad measuring 200mm in X, positioned
symmetrically about XA=−900. The stiffness of the pad may be chosen by the team. Rubber or
foam may be used between the pad and the test structure.
...
a.
The deceleration profile measured in g from the first deformation of the complete assembly to
XA=−382 does not exceed the limit curve defined by 13.5/ X1.13, where X is the longitudinal
distance from XA=0, calculated by the test laboratory in metres.
b.
The peak deceleration does not exceed 40g.
c.
Exceptionally, when filtered with a CFC60 filter (ISO 6487), the limit curve may be exceeded by
...
b.
The average deceleration over the first 150mm of deformation of the FIS must exceed 2.5g.
c.
...
i.
Any significant change in the construction of the FIS such as inserts, or openings.
...
i.
Brake reservoirs, their mounting brackets, associated pipes and fittings.
ii.
...
Rear Impact Structure
C13.7.1
Rear Impact Structure Definition
...
The resistance of the test structure must be such that during the impact:
a.
The deceleration profile measured in g does not exceed the limit curve defined by 15 + 26.5 X,
...
c.
For X>0.225m, the maximum deceleration may exceed the limits defined in (a) and (b) for up to
a cumulative 15ms.
...
b.
Is approved according to the FIA Standard 8876−2022 and homologated for Class II fires, with
the exception of:
i.
...
Two further lights
a.
Must be fitted, one on each side of the car, within the bodywork defined in Article C3.11.2 and
...
C
e.
Be fitted in accordance with the instructions detailed in the document FIA-F1-DOC-025.
C14.3.4
...
ii.
Do not bend the tether round a radius of less than 7.5mm at the specified load.
...
radius of less than 3mm at the specified load. This fixing should withstand a load of 24kN in a
rearward direction at up to 22.5° from the X−axis. The attachment to the RIS should be behind
XDIF=650, and must not bend the tether round a radius of less than 3mm at the specified load. This
fixing should withstand a load of 24kN in a forward direction.
...
Driver Cooling System
C14.6.1
The driver cooling system is defined as a system, the sole purpose which, is to provide additional
...
C14.6.8
Parts of the thermal store for the driver cooling system which are in the volumes defined in Articles
C13.5.1.d or C13.6.5.d must be homologated as follows.
The Thermal Store:
a.
complete and filled with coolant, must be cooled to its minimum operating temperature.
b.
...
c.
offer an unobscured view of the highlighted surface of RV-LATERAL-SAFETY-LIGHT from the
...
C15.1.4
No parts of the car may be made from metallic materials that have a specific modulus of elasticity
...
C15.1.8
Unless explicitly permitted otherwise for a specific application, only material approved by the FIA
...
a.
Thermoplastics – monolithic or particulate filled.
b.
Thermosets – monolithic or particulate filled.
C15.3
Specific Prohibitions and Restrictions (Components Outside the PU Perimeter)
Advisory Committee: TAC
Governance: F1 Commission / WMSC
...
e.
All seals and rubbers (e.g. rubber boots, o−rings, gaskets, any fluid seals, bump rubbers).
f.
...
Adhesives.
k.
Thermal Insulation (e.g. felts, reflective foils or heat shields).
l.
...
a.
CC100 – Woven carbon cloth, fibre weight between 50gsm and 150 gsm, epoxy prepreg
b.
KC60 – Woven aramid cloth, fibre weight 60gsm, epoxy prepreg
c.
KC170 − Woven aramid cloth, fibre weight 170gsm
d.
R135 – 135gsm elastomeric material
e.
R350 – 350gsm elastomeric material
f.
CC-UHS − Woven carbon cloth, fibre Ftu > 6250MPa, epoxy prepreg
C15.5.2
...
b.
PL−ANTI−SPLINTER may be one of the three specifications listed below:
i.
...
C15.6.1
Unless explicitly permitted for a specific application, the following materials may not be used on
the Power Unit:
a.
...
based alloy.
C15.8.2
Static components that are not in contact with the exhaust gas flow nor the compressor gas flow
...
C15.8.7
Additive manufacture is only permitted in three areas within the exhaust assemblies as defined in
5.1.20 (see drawing 8 in Appendix C3 is a representation of these constraints, included for reference
only):
a.
One stub/flange element per primary at the connection to the Cylinder Head. The maximum
...
C16.1.5
The function of an engine oil is to lubricate moving parts, to improve efficiency by reducing friction
...
C16.1.9
Only one oil specification, as defined in C16.1.5, is allowed inside the PU perimeter, with the
...
Greases are not considered as part of this restriction.
C16.1.10
Excluding fuel, hydraulic fluid, ERS fluid and engine oil as defined in C16.1.5, any other liquid inside
...
Composition of the fuel
C16.3.1
The composition of the petrol must comply with the specifications detailed below:
Component
Units
Min
Max
...
C16.3.3
The only oxygenates permitted are paraffinic monoalcohols and paraffinic monoethers with a final
...
C
C16.3.4
An additive package from non-sustainable sources, comprising Additives (as defined in Appendix
...
b.
Two separate five litre samples, in suitable containers, must be submitted to the FIA for
analysis and approval.
c.
Each AS fuel component and/or AS refinery stream must undergo a compliance process
...
C16.5.2
Fuel density will also be checked and must be within 0.15% of the figure noted during preapproval
analysis.
C16.5.3
...
b.
Unless otherwise specified, such components/equipment will be classified as LTC.
c.
All Aerodynamic Components described in Article C3 are LTC, unless specifically defined as
SSC, or OSCNT.
d.
...
e.
In cases of doubt, the FIA should be consulted and shall determine the classification of a
...
C17.2.3
Although it is permissible to be influenced by the design or concept of an F1 Team's LTC using
...
Championship.
g.
The FIA may issue guidance from time to time to define more specifically the requirements and
...
such in Appendix C6).
C17.3.2
Should a selection process fail to lead to appointment of a supplier of a component classified as a
...
C
C17.3.3
Components supplied as SSC must not be modified, and they must be installed and operated
...
C17.5.2
For all OSC and OSCNT in use by all F1 Teams, the Design Specification must reside on a designated
...
039.
C17.5.3
Any F1 Team who designs a new OSC or OSCNT, or modifies the Design Specification of a previous
...
C17.5.4
Any F1 Team who creates a new, or modifies an existing, Design Specification of an OSC or OSCNT
...
C
C17.5.6
In the event the OSC or OSCNT or the Design Specification of any OSC or OSCNT contains
...
b.
Contain sufficient information for another F1 Team to be able to order an identical component
from the supplier.
c.
...
designated server.
C17.5.9
OSCs may be provided from one F1 Team to another, provided that the specification supplied from
...
C17.5.11
For any year (N) where a component is designated as OSC or OSCNT for the first time, F1 Teams in
...
C
C17.6.1
“Defined Specification Components” (DSC) are components produced to a technical
...
C17.6.4
The technical specification of a DSC (to its required level of detail) will be defined by the FIA and
...
C17.6.6
The number of variants that an approved DSC supplier may supply will be defined in the technical
...
C17.6.8
Should a selection process fail to approve sufficient suppliers to cover the requirements of all F1
...
Classification:
a.
All Power Unit components used in Formula One cars shall be classified as:
i.
...
b.
Unless otherwise specified, or determined by the FIA, such components/equipment will be
classified as LPUC.
c.
In cases of doubt, the FIA should be consulted and shall determine the classification of a
...
C18.3.2
In certain cases, determined by the FIA in its sole discretion, more than one configuration of an
...
C
C18.3.4
PU components supplied as SSPUC must not be modified, and they must be installed and operated
...
C18.4.2
For all OSPUC in use by all PU Manufacturers, the Design Specification must reside on a designated
server specified by the FIA and be accessible by all PU Manufacturers. Details of the server, access
credentials and file naming and format conventions may be found in the document FIA-F1-DOC-
039.
C18.4.3
Any PU Manufacturer who designs a new OSPUC or modifies the Design Specification of a previous
...
C
C18.4.4
Any PU Manufacturer who creates a new, or modifies an existing, Design Specification of an OSPUC
...
C18.4.6
In the event the OSPUC or the Design Specification of any OSPUC contains proprietary information
...
b.
Contain sufficient information to enable another PU Manufacturer to order an identical OSPUC
...
C18.4.9
For any year (N) where a PU component is designated as OSPUC for the first time, PU Manufacturers
...
Defined Specification Power Unit Components (DSPUC)
C18.5.1
“Defined Specification Power Unit Components” (“DSPUC”) are PU components whose overall
...
C18.5.3
The technical specification of a DSPUC (to its required level of detail) is defined by the FIA and
...
C18.5.4
An approved DSPUC supplier may make only one technical specification and design of a DSPUC.
...
Articles C9.1.2 to C9.1.4) and the casing in which they are housed (further defined under Gearbox
...
Override Mode As defined in Appendix B1 “Overtake”: A mode, when activated and in
...
PU Manufacturers.
b.
Is not supplied to a specification tighter than the standards listed in Section C15.2 (where
...
c.
rights to use, and protect the confidentiality of, trade secrets, know−how and confidential
information;
d.
...
General Definitions
1.1
This Appendix defines the construction of CAD reference sections, Reference Surfaces and
...
1.5
The prefix “RV-“ always refers to a Reference Volume, whereas the prefix “RS-“ refers to a Reference
Surface.
1.6
...
2.1
The legality volumes and surfaces listed below are defined exclusively by CAD data and are
...
FIA-LEG-0235
B C
Positioned as specified in C3.6.1
RV-SKID-REAR
FIA-LEG-0256
A
Positioned as specified in C3.6.1
...
3.3
Once the surface in §3.2 is fully defined, it must be extruded along X to XPU = −1500.
3.4
Once the volume in §3.3 is fully defined; it must be trimmed by the surface RS-PU-FWD-ERS with
all material ahead of this surface discarded.
3.5
The fully defined volume in §3.4 is “RV-PU-ERS”
4
...
4.3
Once the volume in §4.2 is fully defined, it must be trimmed with a plane passing through the
following three points with all material below the plane discarded.
a.
[XF = 1650, 250, 0], [XF = 850, 250, 0], [XF = 1650, 375, 10].
4.4
Once the volume in §4.3 is fully defined, an Edge Radius of R200, applied to the external corner that
...
4.6
Once the section in §4.5 is fully defined it must be extruded along Y to Y= 400.
4.7
Once the volume in §4.4 and the sheet in §4.6 are fully defined, the volume must be trimmed with
the sheet with all material above the sheet discarded.
4.8
Once the volume in §4.7 is fully defined, it must be trimmed with a plane passing through the
...
4.10
Once the surface in §4.9 is fully defined, it must be extruded along Z to Z = 250.
4.11
On a plane through Y=0, a section whose edges pass through the following [X, Z] vertices
sequentially:
a.
...
250].
4.12
Once the section in §4.11 is fully defined, it must be extruded along Y to Y = 770.
4.13
Once the volume in §4.10 and the sheet in §4.12 are fully defined, the volume must be trimmed with
the sheet with all material above the sheet discarded.
4.14
...
4.15
Once the section in §4.14 is fully defined, it must be extruded along X to XF = 1775.
4.16
Once the volume in §4.13 and the sheet in §4.15 are fully defined, the volume must be trimmed with
the sheet with all material above the sheet discarded.
4.17
An axis-aligned cuboid, which has one interior diagonal defined by the points:
a.
[XR = −600, 400, 75], [XR = −335, 760, 250].
4.18
Once the volume in §4.17 is fully defined, it must be trimmed with a plane passing through the
following three points with all material inboard of the plane discarded.
a.
[XR = −600, 550, 75], [XR = −335, 400, 75], [XR = −335, 400, 250].
4.19
Once the volume in §4.18 is fully defined, it must be subtracted from the volume defined in §4.16
...
4.21
Once the surface in §4.20 is fully defined, it must be extruded along Y to Y = 345.
4.22
An axis-aligned cuboid, which has one interior diagonal defined by the points:
a.
[XR = −325, 345, 50], [XR = 300, 400, 100].
4.23
Once the volumes in §4.21 and §4.22 are fully defined, they must be subtracted from the volume
defined in §4.19 to leave one unified volume.
4.24
Once the volumes in §4.8 and §4.23 are fully defined, they must be united to create a single unified
volume.
...
5.2
Once the surface in §5.1 is fully defined, it must be extruded along Z to Z = 275.
5.3
Once the volume in §5.2 is fully defined, it must be trimmed with the sheet from §4.12 with all
...
6.2
Once the surface in §6.1 is fully defined, it must be extruded along Z to Z = 100.
...
7.3
Once the volume in §7.2 is fully defined, it must be trimmed with a plane passing through the
...
8.2
Once the surface in §8.1 is fully defined, it must be extruded along Z to Z = 50.
...
9.2
Once the volume in §9.1 is fully defined, it must be trimmed with the sheet defined in §4.15 with all
material above the sheet discarded.
...
750], [XR = −825, 750].
10.2
Once the surface in §10.1 is fully defined, it must be extruded along Z to Z = 85.
10.3
Once the volume in §10.2 is fully defined, it must be trimmed with a plane passing through the
...
[XF=430, 0]
11.2
Once the surface in §11.1 is fully defined, a fillet of radius 25mm must be applied at vertex at
[XF=430, 75] and a fillet of radius 2000mm must be applied at the vertices at [XF=690, 125] and
[XR=−1300, 125].
11.3
Once the surface in §11.2 is fully defined it must be extruded along Z to Z=−10.
11.4
Once the volume in §11.3 is fully defined; a chamfer of 6mm x 100mm must be applied to the lower
edge at XR=−350 and a chamfer of 6mm x 12mm must be applied to the remaining lower edges.
11.5
The fully defined volume in §11.4 is “RV-PLANK”.
12
...
12.3
Once the surface in §12.2 is fully defined, it must be extruded along Y to Y = 400.
12.4
Once the volumes in §12.1 and §12.3 are fully defined, they must be combined with ALL non-
...
75].
12.6
Once the surface in §12.5 is fully defined, it must be extruded along Y to Y = 400.
12.7
An axis-aligned cuboid, which has one interior diagonal defined by the points:
a.
[XC, 170, 680], [XC = 75, 400, 970].
12.8
Once the volumes in §12.4, §12.6 and §12.7 are fully defined, they must be combined to make one
unified volume.
12.9
...
12.10
Once the surface in §12.9 is fully defined, it must be extruded along Z to Z = 970.
12.11
Once the volumes in §12.8 and §12.10 are fully defined, they must be combined with all non-
overlapping regions discarded.
The fully defined volume in §12.11 is “RV-BODY-FRONT”
12.12
RV-BODY-FRONT is further split by the planes defined in Article 2.7:
a.
...
13.2
Once the volume in §13.1 is fully defined, it must be trimmed with the plane XA = 0 with all material
ahead of this plane discarded.
13.3
Once the volume in §13.2 is fully defined, radii with a convex radius of curvature of 50mm must be
...
14.2
Once the surface in §14.1 is fully defined, it must be extruded along Z to Z = 720.
...
15.3
Once the volumes in §15.1 and §15.2 are fully defined, they must be combined with all non-
overlapping regions discarded.
...
16.2
Once the surface in §16.1 is fully defined, it must be extruded along Z to Z = 600.
...
17.2
Once the surface in §17.1 is fully defined, it must be extruded along Z to Z = 600.
17.3
Once the volume in §17.2 is fully defined, it must be trimmed with a plane passing through the
following three points with all material above the plane discarded.
a.
...
17.5
Once the surface in §17.4 is fully defined, it must be extruded along Y to Y = 400.
17.6
Once the volume in §17.5 is fully defined, it must be trimmed with a plane passing through the
following three points with all material outboard of the plane discarded.
a.
...
825].
17.8
Once the surface in §17.7 is fully defined, it must be extruded along Y to Y = 25.
17.9
An axis-aligned cuboid, which has one interior diagonal defined by the points:
a.
[XC = 75, 170, 50], [XC = 320, 400, 970].
17.10
Once the volumes in §17.3, §17.6, §17.8 and §17.9 are fully defined they must be united to create a
...
380].
18.2
Once the surface in §18.1 is fully defined, it must be extruded along Z to Z = 700.
...
0].
19.2
Once the surface in §19.1 is fully defined, it must be extruded along Y to Y = 145.
19.3
...
19.4
Once the surface in §19.3 is fully defined, it must be extruded along Z to Z = 500.
19.5
Once the volumes in §19.2 and §19.4 are fully defined, they must be combined with all non-
overlapping regions discarded.
...
22.2
Once the surface in §22.1 is fully defined, it must be extruded along X to XF = −475.
...
C
22.3
Once the volume in §22.2 is fully defined, it must be trimmed using the plane defined in §21.1 with
all material forward of the plane discarded.
22.4
Once the volume in §22.3 is fully defined, it must be trimmed with a plane passing through the
...
23.2
Once the volume in §23.1 is fully defined, it must be trimmed using the plane defined in §21.1 with
all material forward of the plane discarded.
23.3
A cylinder of diameter 925mm centred on the Y-Aligned axis [XF, Z] = [0, 360], extruded between Y =
560, to Y = 900.
23.4
Once the cylinder in §23.3 is fully defined, it must be used to trim the volume in §23.2 with both the
cylinder and all overlapping regions discarded.
23.5
Once the volume in §23.4 is fully defined, it must be trimmed with a plane passing through the
following three points with all material above the plane discarded.
a.
...
24.2
Once the volume in §24.1 is fully defined, it must be trimmed using the plane defined in §21.1 with
all material forward of the plane discarded.
24.3
Once the volume in §24.2 is fully defined, it must be trimmed with the cylinder defined in §23.3 with
...
25.2
Once the volume in §25.1 is fully defined, it must be trimmed using the plane defined in §21.1 with
all material forward of the plane discarded.
...
C
25.3
Once the volume in §25.2 is fully defined, it must be trimmed with the cylinder defined in §23.3 with
both the cylinder and all overlapping regions discarded.
...
26.2
Once the volume in §26.1 is fully defined, it must be trimmed with the plane defined in §23.5 with
...
27.2
Once the volume in §27.1 is fully defined, it must be trimmed using the plane defined in §21.1 with
all material forward of the plane discarded.
...
to X = 60.
28.3
Once the volumes in §28.1 and §28.2 are fully defined, they must be united to create a single unified
volume.
...
29.2
Once the volume in §29.1 is fully defined, it must be trimmed with the following planes:
a.
...
30.2
Once the volume in §30.1 is fully defined, it must be trimmed with a plane passing through the
following three points with all material below the plane discarded.
a.
...
250].
31.2
Once the surface in §31.1 is fully defined, it must be extruded along X to XR = 750.
31.3
Once the volume in §31.2 is fully defined, it must be trimmed with the following planes:
a.
...
C
32.2
Once the surface in §32.1 is fully defined, it must be extruded along Y to Y = 110.
...
35.1
On the plane Y=0, a profile of two lines passing through the following points [XC, Z];
a.
[−740, 0], [−875, 235], [−875, 650].
35.2
Once the profile in §35.1 is fully defined, it must be extruded in Y to Y = 500.
...
36.1
On the plane Y=0, a profile of two lines passing through the following points [X, Z];
a.
[XC = 0, 550], [XPU = −75, 450], [XPU = −75, 100].
36.2
Once the profile in §36.1 is fully defined, it must be extruded in Y to Y = 500.
...
EXC
93
Garage equipment defined as compulsory by Manufacturer (including but not
limited to tool sets required for PU trackside support activities, dielectric fluid
...
1.5
PU Manufacturers carrying out modifications to the homologated Power Unit under the provisions
...
b.
before the 1st of November, the Preliminary Dossier for specific parts of the entire
Power Unit.
1.7
...
Teams:
i.
A final full external space model of the Power Unit including details and locations of all
physical interfaces required by the team to install the Power Unit.
ii.
...
3.1
Following the first homologation of a Power Unit by a PU Manufacturer in the period 2026-2030,
...
Championship season.
3.3
PU Manufacturers who fulfil the criteria described by Article 4 of this Appendix in year N, will be
...
Appendix C4
b.
will require the submission of an updated homologation dossier as specified in the Article 1.5
of this Appendix
...
b.
can be introduced from the first Competition following the ADUO grant, in addition to any other
...
Wirings
b.
Exhaust system, provided the key defining parameters of the system (diameters, lengths, etc.)
...
f.
Engine intake air system as defined in item 6 of Appendix C4, provided the key defining
parameters of the system (diameters, lengths, etc.) remain fundamentally unchanged
g.
All parts listed in item 71 (e.g., pneumatic bottles, hoses, filling valves) and hydraulic system
hoses for PU control listed in item 64 of Appendix C4
3.6
Modifications may be made to Power Unit components for the sole purposes of reliability, safety,
cost saving, or supply issues, subject to the approval process outlined in Article 3.10.a of this
Appendix.
3.7
Minor modifications may be made to Power Unit components subject to the approval process
...
3.10
The following additional constraints apply to the permitted modifications discussed in this Article
3:
a.
To carry out modifications under the provisions of Articles 3.5, 3.6 and 3.7 of this Appendix, PU
...
b.
Any permitted modifications concerning parts that are inside the sealed perimeter (i.e. parts
...
d.
A Customer Team may refuse or request a delay of a Power Unit modified under the provisions
...
apply.
e.
The first time one or more Power Units comprising modified parts, as permitted by Articles 3.3
...
the PU Manufacturer.
g.
The requirements of e. and f. don’t apply to minor modifications as defined in 3.7.
h.
...
i.
One will be subject to The push-off tests described in Articles C13.6.3.a and C13.6.3.b
followed by dynamic test described in Article C13.6.5.
and or
ii.
The second will be subject to The push-off test described in Article C13.6.3.c followed by
the dynamic test described in Article C13.6.6.
In the case where a dynamic test did not meet the acceleration requirements, at the discretion of
the FIA, the Competitor may be permitted to repeat only the failed test.
C5.17.4
All cars must be fitted with one ERS Status Buzzer unit which:
a.
Have been supplied by an FIA designated manufacturer and fitted to the car in accordance with
...
e.
have an incidence (defined as the angle between the major axis and the plane Z=0 with the car
at its legality ride height, as defined in Article C10.1) which lies within the following ranges:
i.
For Front Suspension Fairings, between 10deg (nose down) and 0deg.
ii
For Rear Suspension Fairings, between 10deg (nose down) and –10deg (nose up).
...
C3.11.7
Rear Wing Auxiliary Components
Once Rear Wing Assembly has been fully defined, the following “Rear Wing Auxiliary Components”,
which are exempt from Article C3.2.4, may be fitted:
{...}
e.
